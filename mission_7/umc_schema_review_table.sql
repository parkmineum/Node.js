...
CREATE TABLE `review_table` (
  `review_table_id` bigint NOT NULL,
  ...
  CONSTRAINT `mission_id_review` FOREIGN KEY (`mission_id`) REFERENCES `mission` (`mission_id`),
  CONSTRAINT `review_id_review` FOREIGN KEY (`review_id`) REFERENCES `review` (`review_id`),
  CONSTRAINT `user_id_review` FOREIGN KEY (`user_id`) REFERENCES `user` (`user_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='mapping_table	';
